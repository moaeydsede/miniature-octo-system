  ...
  function render(){
    ...
    if(currentTab==="departments"){
      ...
      document.getElementById("addDept").onclick = ()=>{
        ...
        const st2 = loadState();
        st2.departments.push({ id: crypto.randomUUID(), name });
    ...
    if(currentTab==="employees"){
      ...
      document.getElementById("addEmp").onclick = ()=>{
        ...
        const st2=loadState();
        st2.employees.push({ id: crypto.randomUUID(), name, code, departmentId: dept, monthlySalary: salary, active:true });
      ...
      document.getElementById("doImportExcel").onclick = async ()=>{
        ...
        if(wb.Sheets["Employees"]){
          ...
          const newEmps = rows.map(r=>{
            ...
            return { id: crypto.randomUUID(), name, code, departmentId: deptId, monthlySalary: salary, active };
          });
